...
import { TokenRecord } from "../hooks/useLocalStorage"

interface HistoryPanelProps {
    history: TokenRecord[]
    onDeleteRecord: (address: string) => void
    onClearHistory: () => void
}

export function HistoryPanel({ history, onDeleteRecord, onClearHistory }: HistoryPanelProps) {
